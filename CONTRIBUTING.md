...
[Code of Conduct]: https://github.com/MiniBossGPT/Mini-Boss/blob/main/CODE_OF_CONDUCT.md

## 📢 A Quick Word
Right now we will not be accepting any Contributions that add non-essential commands to Mini-Boss.
...
https://github.com/MiniBossGPT/Mini-Boss/pulls?q=is%3Apr+is%3Aopen+-label%3Aconflicts
...
- If the prompt changes in a way that the cassettes are not reusable:
    ...
    - If the API key is present, the tests will make a real call to OpenAI.
        ...
        - If the test is unsuccessful:
            - Either: Your change made Mini-Boss less capable, in that case, you have to change your code.
