...
"""
A module that contains the BossConfig class object that contains the configuration
"""
...
class BossConfig:
    ...
    Attributes:
        ...
        target_percentage (float): The value required of the workers performance
        complete_percentage (float): The value required of the workers performance
    """
    ...
    def __init__(
        ...
        ai_task_results: list | None = None,
        ...
        if ai_tasks is None:
            ai_tasks = []
        if ai_task_results is None:
            ai_task_results = []
        self.ai_name = ai_name
        self.ai_role = ai_role
        self.ai_job = ai_job
        self.ai_tasks = ai_tasks
        self.ai_task_results = ai_task_results
    ...
    @staticmethod
    def load(config_file: str = SAVE_FILE) -> "BossConfig":
        """
        ...
        ai_task_results = config_params.get("ai_task_results", [])
    ...
    def save(self, config_file: str = SAVE_FILE) -> None:
        ...
        config = {
            ...
            "ai_task_results": self.ai_task_results,
    ...
    def construct_full_prompt(
        ...
        prompt_generator.ai_task_results = self.ai_task_results
        prompt_generator.target_percentage = self.target_percentage
        prompt_generator.target_percentage = self.target_percentage
        prompt_generator.complete_percentage = self.complete_percentage
