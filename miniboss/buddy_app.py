...
def get_buddy_command(response_json: Dict):
...
def map_buddy_command_synonyms(command_name: str):
...
def execute_buddy_command(
    ...
    try:
        ...
        command_name = map_buddy_command_synonyms(command_name.lower())
...
@command(
    "get_buddy_text_summary",
    "Get text summary",
    '"url": "<url>", "question": "<question>"',
)
@validate_url
def get_buddy_text_summary(url: str, question: str) -> str:
...
@command("get_buddy_hyperlinks", "Get text summary", '"url": "<url>"')
@validate_url
def get_buddy_hyperlinks(url: str) -> Union[str, List[str]]:
    """Return the results of a Google search
