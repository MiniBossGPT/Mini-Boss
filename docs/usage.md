...
Here are some common arguments you can use when running Mini-Boss:

* Run Mini-Boss with a different AI Settings file
...
Enter this command to use TTS _(Text-to-Speech)_ for Mini-Boss
...
If you don't have access to GPT-4, this mode allows you to use Mini-Boss!
...
If you have access to GPT-4, this mode allows you to use Mini-Boss solely with GPT-4.
...
!!! warning
    Since GPT-4 is more expensive to use, running Mini-Boss in GPT-4-only mode will
